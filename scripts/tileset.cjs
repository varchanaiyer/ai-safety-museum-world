...
module.exports = function buildTileset(M) {
  ...
  const ART = {
    ...
    panda: (s, x, y, k) => { for (const dx of [-7, 5]) { s.rect(x + dx * k - 5 * k, y - 6 * k, 10 * k, 12 * k, "#60785a"); s.circle(x + dx * k, y + 1 * k, 3 * k, "#f4f2ec"); s.circle(x + dx * k - 1.5 * k, y, k, "#181618"); s.circle(x + dx * k + 1.5 * k, y, k, "#181618"); } s.text(x - k, y - 2 * k, "+", { color: INK_DIM, scale: Math.max(1, k / 2 | 0) }); },
    ...
    alarm: (s, x, y, k) => { s.rect(x - 7 * k, y - 7 * k, 14 * k, 14 * k, "#b8332a"); s.frame(x - 7 * k, y - 7 * k, 14 * k, 14 * k, "#f4f2ec"); s.text(x, y - 2 * k, "!", { align: "center", color: "#f4f2ec", scale: Math.max(1, k | 0) }); },
    ...
    buttons: (s, x, y, k) => { s.rect(x - 11 * k, y - 4 * k, 9 * k, 9 * k, "#3f9e5f"); s.rect(x + 2 * k, y - 4 * k, 9 * k, 9 * k, "#8c2f2a"); s.text(x - 7 * k, y - 2 * k, "+", { align: "center", color: "#ffffff", scale: Math.max(1, k / 2 | 0) }); s.text(x + 6 * k, y - 2 * k, "-", { align: "center", color: "#ffffff", scale: Math.max(1, k / 2 | 0) }); },
    ...
    tray: (s, x, y, k) => { for (const [dy, c] of [[4, "#c9ccd4"], [-4, "#c9ccd4"]]) { s.frame(x - 12 * k, y + dy * k - 3 * k, 24 * k, 6 * k, c); } s.rect(x - 10 * k, y - 6 * k, 20 * k, 2 * k, "#f4f2ec"); s.rect(x - 10 * k, y - 9 * k, 20 * k, 2 * k, "#f4f2ec"); s.rect(x - 10 * k, y + 3 * k, 20 * k, 2 * k, "#f4f2ec"); s.text(x - 8 * k, y - 2 * k, "IN", { color: "#26232c", scale: Math.max(1, k / 2 | 0) }); },
    ...
    phonebook: (s, x, y, k) => { s.rect(x - 10 * k, y - 3 * k, 20 * k, 11 * k, "#e0d8b8"); for (let i = 0; i < 5; i++) s.rect(x - 10 * k, y - 2 * k + i * 2 * k, 20 * k, 1 * k, "#c8bf9c"); s.rect(x - 10 * k, y - 8 * k, 20 * k, 5 * k, "#c8a03c"); s.text(x, y - 7 * k, "A-Z", { align: "center", color: "#4a3a10", scale: Math.max(1, k / 2 | 0) }); },
    ...
    seal: (s, x, y, k) => { s.rect(x - 11 * k, y - 8 * k, 22 * k, 16 * k, "#f4f2ec"); for (let i = 0; i < 4; i++) s.rect(x - 8 * k, y - 6 * k + i * 2.5 * k, 12 * k, 1 * k, "#9a927e"); s.circle(x + 6 * k, y + 3 * k, 5 * k, "#b23a30"); s.ring(x + 6 * k, y + 3 * k, 5 * k, "#8a1f18", 255, k); s.text(x + 6 * k, y + 1 * k, "OK", { align: "center", color: "#f4f2ec", scale: Math.max(1, k / 3 | 0) }); },
    ...
    proof: (s, x, y, k) => { for (let i = 0; i < 7; i++) s.rect(x - 11 * k + i * 0.7 * k, y + 5 * k - i * 1.8 * k, 18 * k, 1.6 * k, i % 2 ? "#f4f2ec" : "#e6e0d0"); s.rect(x - 11 * k, y + 7 * k, 20 * k, 1 * k, "#000000", 70); s.rect(x + 6 * k, y - 9 * k, 3 * k, 14 * k, "#b23a30"); s.rect(x + 6 * k, y + 5 * k, 3 * k, 2 * k, "#26232c"); },
    cubicle: (s, x, y, k) => { s.rect(x - 13 * k, y - 8 * k, 26 * k, 16 * k, "#8e8578"); s.rect(x - 13 * k, y - 8 * k, 26 * k, 2 * k, "#a89d8c"); s.rect(x - 13 * k, y + 6 * k, 26 * k, 2 * k, "#6e6659"); s.rect(x - 1 * k, y - 8 * k, 2 * k, 16 * k, "#6e6659"); s.rect(x - 10 * k, y - 5 * k, 7 * k, 5 * k, "#f4f2ec"); s.rect(x - 9 * k, y - 4 * k, 5 * k, 3 * k, "#3f6a8a"); s.circle(x - 6.5 * k, y - 6 * k, 0.9 * k, "#b23a30"); s.rect(x + 3 * k, y - 4 * k, 8 * k, 6 * k, "#e8c76a"); },
    splitflap: (s, x, y, k) => { s.rect(x - 13 * k, y - 9 * k, 26 * k, 18 * k, "#0c1220"); s.frame(x - 13 * k, y - 9 * k, 26 * k, 18 * k, "#7ec3e8"); for (let r = 0; r < 4; r++) for (let c = 0; c < 6; c++) { s.rect(x - 11 * k + c * 4 * k, y - 7 * k + r * 4 * k, 3 * k, 3 * k, r === 1 && c > 3 ? "#e8c76a" : "#1a2a3a"); if (r !== 1 || c <= 3) s.rect(x - 11 * k + c * 4 * k, y - 5.8 * k + r * 4 * k, 3 * k, 0.5 * k, "#0c1220"); } },
    hook: (s, x, y, k) => { s.rect(x - 11 * k, y - 9 * k, 22 * k, 17 * k, "#3d372f"); s.rect(x - 9 * k, y - 7 * k, 18 * k, 13 * k, "#6a6156"); s.line(x - 1 * k, y - 9 * k, x - 1 * k, y - 5 * k, "#c9ccd4"); s.circle(x, y - 4 * k, 1.4 * k, "#c9ccd4"); },
    datacolumn: (s, x, y, k) => { s.rect(x - 13 * k, y - 9 * k, 26 * k, 18 * k, "#f2ece0"); for (let r = 0; r < 6; r++) { s.rect(x - 11 * k, y - 7 * k + r * 3 * k, 7 * k, 1.8 * k, "#9a927e"); s.rect(x - 2 * k, y - 7 * k + r * 3 * k, 6 * k, 1.8 * k, "#26232c"); s.rect(x + 6 * k, y - 7 * k + r * 3 * k, 5 * k, 1.8 * k, r % 2 ? "#b23a30" : "#3f8a44"); } },
    polygons: (s, x, y, k) => { const R = mulberry(19); for (let r = 0; r < 4; r++) for (let c = 0; c < 5; c++) { const px2 = x - 11 * k + c * 5.5 * k, py2 = y - 8 * k + r * 5 * k, sq = R() < 0.5; if (sq) s.rect(px2, py2, 3.6 * k, 3.6 * k, "#e8c76a"); else { for (let i = 0; i < 4 * k; i++) s.rect(px2 + 1.8 * k - i * 0.45, py2 + i, Math.max(1, i * 0.9), 1, "#7ec3e8"); } } },
    armchair: (s, x, y, k) => { s.rect(x - 11 * k, y - 4 * k, 22 * k, 12 * k, "#7a4a3a"); s.rect(x - 8 * k, y - 9 * k, 16 * k, 7 * k, "#8e5847"); s.rect(x - 12 * k, y - 3 * k, 4 * k, 9 * k, "#6a4030"); s.rect(x + 8 * k, y - 3 * k, 4 * k, 9 * k, "#6a4030"); s.circle(x, y - 12 * k, 4 * k, "#e2b184"); s.ellipse(x, y - 14 * k, 4.2 * k, 2 * k, "#9a9aa2"); },
    profiles: (s, x, y, k) => { for (let r = 0; r < 2; r++) for (let c = 0; c < 4; c++) { const px2 = x - 13 * k + c * 6.8 * k, py2 = y - 8 * k + r * 8.5 * k; s.rect(px2, py2, 5.8 * k, 7 * k, "#f2ece0"); s.circle(px2 + 2.9 * k, py2 + 2.4 * k, 1.5 * k, (r * 4 + c) % 3 ? "#8a8f9a" : "#b23a30"); s.rect(px2 + 1 * k, py2 + 4.6 * k, 3.8 * k, 0.8 * k, "#9a927e"); s.rect(px2 + 1 * k, py2 + 5.8 * k, 2.6 * k, 0.8 * k, "#9a927e"); } },
    static: (s, x, y, k) => { const R = mulberry(23); for (let j = 0; j < 12; j++) for (let i = 0; i < 18; i++) { const t = i / 17; const px2 = x - 13 * k + i * 1.5 * k, py2 = y - 9 * k + j * 1.5 * k; if (R() < 1 - t) s.rect(px2, py2, 1.5 * k, 1.5 * k, [R() * 255 | 0, R() * 255 | 0, R() * 255 | 0]); else s.rect(px2, py2, 1.5 * k, 1.5 * k, j > 4 && j < 9 && i > 11 ? "#3f8a44" : "#a9c8e0"); } },
    curve: (s, x, y, k) => { s.rect(x - 13 * k, y - 9 * k, 26 * k, 18 * k, "#f2ece0"); for (let i = 0; i < 5; i++) s.rect(x - 13 * k, y - 7 * k + i * 4 * k, 26 * k, 0.5 * k, "#c8c0ae"); s.rect(x - 11 * k, y - 8 * k, 0.8 * k, 16 * k, "#3a3834"); s.rect(x - 11 * k, y + 7 * k, 24 * k, 0.8 * k, "#3a3834"); for (let i = 0; i < 14 * k; i++) s.rect(x - 10 * k + i, y + 4 * k, 1, 1.4 * k, "#b23a30"); for (let i = 0; i < 5 * k; i++) s.rect(x + 4 * k + i, y + 4 * k - i * 1.6, 1, 1.4 * k, "#b23a30"); for (let i = 0; i < 5 * k; i++) s.rect(x + 9 * k + i, y - 4 * k, 1, 1.4 * k, "#b23a30"); },
    doodle: (s, x, y, k) => { s.rect(x - 13 * k, y - 9 * k, 26 * k, 18 * k, "#f7f4ec"); const R = mulberry(29); for (let g = 0; g < 4; g++) { const gx = x - 10 * k + (g % 2) * 12 * k, gy = y - 5 * k + Math.floor(g / 2) * 9 * k, w = 3.5 * k; s.ring(gx, gy, w, "#26232c", 255, Math.max(1, 0.6 * k)); s.line(gx - w, gy - w, gx - w * 0.4, gy - w * 1.7, "#26232c"); s.line(gx + w, gy - w, gx + w * 0.4, gy - w * 1.7, "#26232c"); s.put(gx - k, gy - 0.4 * k, "#26232c"); s.put(gx + k, gy - 0.4 * k, "#26232c"); for (let i = -1; i <= 1; i += 2) s.line(gx + i * w * 0.5, gy + 0.8 * k, gx + i * w * 1.6, gy + (R() - 0.5) * k, "#26232c"); } },
    captcha: (s, x, y, k) => { s.rect(x - 13 * k, y - 8 * k, 26 * k, 11 * k, "#e8e4dc"); const R = mulberry(11); for (let i = 0; i < 6; i++) { const cx = x - 10 * k + i * 4 * k, o = (R() * 4 - 2) * k; s.rect(cx, y - 6 * k + o, 2 * k, 7 * k, "#3a3a44"); } for (let i = 0; i < 3; i++) s.line(x - 13 * k, y - 6 * k + i * 4 * k, x + 13 * k, y - 3 * k + i * 4 * k, "#9a927e", 150); s.rect(x - 12 * k, y + 5 * k, 6 * k, 6 * k, "#f4f2ec"); s.frame(x - 12 * k, y + 5 * k, 6 * k, 6 * k, "#3a3a44"); s.text(x + 2 * k, y + 6 * k, "HUMAN", { color: "#9a927e", scale: Math.max(1, k / 3 | 0) }); },
    orb: (s, x, y, k, col) => { s.circle(x, y, 8 * k, col || "#2e5fd0", 90); s.circle(x, y, 5 * k, col || "#2e5fd0"); s.circle(x - 2 * k, y - 2 * k, 1.5 * k, "#ffffff", 220); }
  };
  const KIND_RULES = [[/forty-page proof|red pen/, "proof"], [/fabric-walled/, "cubicle"], [/split-flap/, "splitflap"], [/picture hook|unfaded paint/, "hook"],
    [/column of data|redacted/, "datacolumn"], [/triangles and squares/, "polygons"], [/armchair/, "armchair"], [/social media profiles/, "profiles"],
    [/cloud of static/, "static"], [/training curve/, "curve"], [/bad drawings|doodle/, "doodle"], [/hot metal/, "tablet"], [/distorted word|captcha/, "captcha"], [/red button|big red/, "redbutton"], [/key cabinet/, "key"], [/signboard/, "nameplate"],
